...
const CONFIG = {
    ...
    i18n: {
        zh: {
            "title": "我的云桌面", "login_btn": "登录 / 注册", "logout": "退出", "save": "保存", "save_public": "公开",
            "world": "世界广场", "back_home": "返回我的桌面", "comment_ph": "写下你的留言...", "send": "发送",
            "reg_check_email": "注册成功！请检查邮箱验证。", "like": "点赞", "fav": "收藏", "viewing": "正在查看"
        },
        en: {
            "title": "Cloud Desktop", "login_btn": "Login", "logout": "Logout", "save": "Save", "save_public": "Public",
            "world": "World", "back_home": "Back Home", "comment_ph": "Comment...", "send": "Send",
            "reg_check_email": "Check email.", "like": "Like", "fav": "Collect", "viewing": "Viewing"
        }
    },

    defaultIcons: {
        windows: [{ name: "我的电脑", icon: "fa-solid fa-desktop", color: "#0984e3", x: 20, y: 20 }, { name: "回收站", icon: "fa-solid fa-trash-can", color: "#636e72", x: 20, y: 120 }],
    ...
    sidebarTools: {
        ...
        mobile: [
            ...
            { title: "游戏", items: [ { name: "王者荣耀", icon: "fa-solid fa-shield-halved", color: "#f1c40f" } ] }
        ]
    }
};
