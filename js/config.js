...
const CONFIG = {
    ...
    i18n: {
        zh: { "title":"我的云桌面", "login_btn":"登录 / 注册", "logout":"退出", "save":"保存", "save_public":"公开", "world":"世界广场", "back_home":"返回我的桌面", "comment_ph":"写下你的留言...", "send":"发送", "reg_check_email":"注册成功！请检查邮箱验证。", "wallpaper":"更换壁纸", "like": "点赞", "fav": "收藏", "dev_tools": "开发工具", "go_apps": "围棋应用", "social": "社交", "common": "常用软件", "games":"游戏" },
        en: { "title":"Cloud Desktop", "login_btn":"Login", "logout":"Logout", "save":"Save", "save_public":"Public", "world":"World", "back_home":"Back Home", "comment_ph":"Comment...", "send":"Send", "reg_check_email":"Check email.", "wallpaper":"Wallpapers", "like": "Like", "fav": "Collect", "dev_tools": "Dev Tools", "go_apps": "Go/Weiqi", "social": "Social", "common": "Common", "games":"Games" }
    },
    ...
    sidebarTools: {
        windows: [
            ...
            },
            {
                title: "go_apps",
                items: [
                    { name: "野狐围棋", icon: "fa-solid fa-paw", color: "#FF9800" },
                    { name: "弈城围棋", icon: "fa-solid fa-earth-asia", color: "#3498db" },
                    { name: "弈客围棋", icon: "fa-solid fa-comments", color: "#2ecc71" },
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "Weibo", icon: "fa-brands fa-weibo", color: "#E6162D" },
                    { name: "Twitter", icon: "fa-brands fa-twitter", color: "#1DA1F2" }
                ]
            },
            {
                title: "common",
