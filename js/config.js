...
const CONFIG = {
    ...
    // 翻译配置
    i18n: {
        zh: { "title":"我的云桌面", "login_btn":"登录 / 注册", "logout":"退出", "save":"保存", "save_public":"公开", "world":"世界广场", "back_home":"返回我的桌面", "comment_ph":"写下你的留言...", "send":"发送", "reg_check_email":"注册成功！请检查邮箱验证。", "wallpaper":"更换壁纸", "like": "点赞", "fav": "收藏" },
    ...
    defaultIcons: {
        ...
        android: [
            { name: "电话", icon: "fa-solid fa-phone", color: "#2ecc71", x: 25, y: 520 }, 
            { name: "信息", icon: "fa-solid fa-comment", color: "#3498db", x: 95, y: 520 },
            { name: "Chrome", icon: "fa-brands fa-chrome", color: "#f1c40f", x: 165, y: 520 }, 
            { name: "相机", icon: "fa-solid fa-camera", color: "#95a5a6", x: 235, y: 520 },
            { name: "时钟", icon: "fa-solid fa-clock", color: "#fff", x: 25, y: 100 }
        ],
        ios: [
            { name: "电话", icon: "fa-solid fa-phone", color: "#2ecc71", x: 25, y: 520 }, 
            { name: "Safari", icon: "fa-brands fa-safari", color: "#3498db", x: 95, y: 520 },
            { name: "邮件", icon: "fa-solid fa-envelope", color: "#3498db", x: 165, y: 520 }, 
            { name: "音乐", icon: "fa-solid fa-music", color: "#e74c3c", x: 235, y: 520 },
    ...
    sidebarTools: {
        windows: [
            ...
            { title: "办公", items: [ { name: "Word", icon: "fa-solid fa-file-word", color: "#0984e3" }, { name: "Excel", icon: "fa-solid fa-file-excel", color: "#00b894" }, { name: "PPT", icon: "fa-solid fa-file-powerpoint", color: "#e17055" }, { name: "WPS", icon: "fa-solid fa-file-pen", color: "#d63031" } ] },
            { title: "系统", items: [ { name: "Chrome", icon: "fa-brands fa-chrome", color: "#fab1a0" }, { name: "Edge", icon: "fa-brands fa-edge", color: "#74b9ff" }, { name: "VS Code", icon: "fa-solid fa-code", color: "#00a8e8" } ] },
            { title: "娱乐", items: [ { name: "Steam", icon: "fa-brands fa-steam", color: "#2c3e50" }, { name: "WeChat", icon: "fa-brands fa-weixin", color: "#2ecc71" }, { name: "QQ", icon: "fa-brands fa-qq", color: "#3498db" } ] }
        ],
        mobile: [
            { 
                title: "wallpaper", type: "wallpaper",
            ...
            { title: "社交", items: [ { name: "微信", icon: "fa-brands fa-weixin", color: "#2ecc71" }, { name: "抖音", icon: "fa-brands fa-tiktok", color: "#2d3436" }, { name: "小红书", icon: "fa-solid fa-book-open", color: "#e84393" } ] },
            { title: "游戏", items: [ { name: "王者荣耀", icon: "fa-solid fa-shield-halved", color: "#f1c40f" }, { name: "和平精英", icon: "fa-solid fa-person-rifle", color: "#e67e22" } ] }
        ]
    }
};
...
function getToolsForOS(os) {
    ...
    // 增加 fallback 确保 macos/ubuntu 也有工具栏
