        ...
        windows: [
            {
                ...
                items: [
                    ...
                    { name: "WPS", icon: "fa-solid fa-file-pen", color: "#d63031" },
                    { name: "Outlook", icon: "fa-solid fa-envelope", color: "#0984e3" },
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "GitHub", icon: "fa-brands fa-github", color: "#2d3436" },
                    { name: "Node.js", icon: "fa-brands fa-node", color: "#2ecc71" },
                    { name: "Python", icon: "fa-brands fa-python", color: "#f1c40f" },
                    { name: "Terminal", icon: "fa-solid fa-terminal", color: "#333" },
                    { name: "Database", icon: "fa-solid fa-database", color: "#a29bfe" }
                ]
            },
            {
                title: "娱乐 & 游戏",
                items: [
                    ...
                    { name: "Spotify", icon: "fa-brands fa-spotify", color: "#2ecc71" },
                    { name: "Netflix", icon: "fa-solid fa-film", color: "#e74c3c" },
                    { name: "Bilibili", icon: "fa-brands fa-bilibili", color: "#00a1d6" },
                    { name: "Discord", icon: "fa-brands fa-discord", color: "#7289da" }
                ]
            },
            {
                title: "网络 & 社交",
        ...
        macos: [
            {
                ...
                items: [
                    ...
                    { name: "Podcasts", icon: "fa-solid fa-podcast", color: "#a29bfe" },
                    { name: "TV", icon: "fa-solid fa-tv", color: "#2d3436" },
                    { name: "News", icon: "fa-solid fa-newspaper", color: "#e74c3c" },
                    { name: "Photos", icon: "fa-solid fa-images", color: "rainbow" } // 特殊处理
                ]
            },
            {
                title: "Creative",
                items: [
                    ...
                    { name: "Illustrator", icon: "fa-solid fa-pen-nib", color: "#e67e22" },
                    { name: "Figma", icon: "fa-brands fa-figma", color: "#00b894" },
                    { name: "Sketch", icon: "fa-solid fa-diamond", color: "#f1c40f" }
                ]
            }
        ],
        // Android/iOS 共用 mobile
        mobile: [
            {
                title: "社交生活",
                items: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "计算器", icon: "fa-solid fa-calculator", color: "#636e72" },
                    { name: "相册", icon: "fa-solid fa-images", color: "#a29bfe" },
                    { name: "设置", icon: "fa-solid fa-gear", color: "#bdc3c7" }
                ]
            },
            {
                title: "热门游戏",
                items: [
                    ...
                    { name: "原神", icon: "fa-solid fa-star", color: "#a29bfe" },
                    { name: "开心消消乐", icon: "fa-solid fa-paw", color: "#2ecc71" }
                ]
            }
        ],
        ubuntu: [
            {
                ...
                items: [
                    { name: "Terminal", icon: "fa-solid fa-terminal", color: "#333" },
                    { name: "Settings", icon: "fa-solid fa-gear", color: "#bdc3c7" },
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "AWS", icon: "fa-brands fa-aws", color: "#e67e22" }
                ]
            }
        ]
    }
