...
const CONFIG = {
    ...
    defaultIcons: {
        ...
        android: [
            // Y=530 配合手机壳高度 680px，底部留有约 60px 空间
            { name: "电话", icon: "fa-solid fa-phone", color: "#2ecc71", x: 10, y: 530 },
            { name: "信息", icon: "fa-solid fa-comment", color: "#3498db", x: 90, y: 530 },
            { name: "Chrome", icon: "fa-brands fa-chrome", color: "#f1c40f", x: 170, y: 530 },
            { name: "相机", icon: "fa-solid fa-camera", color: "#95a5a6", x: 250, y: 530 },
            { name: "时钟", icon: "fa-solid fa-clock", color: "#fff", x: 20, y: 100 }
        ],
        ios: [
            { name: "电话", icon: "fa-solid fa-phone", color: "#2ecc71", x: 10, y: 530 },
            { name: "Safari", icon: "fa-brands fa-safari", color: "#3498db", x: 90, y: 530 },
            { name: "邮件", icon: "fa-solid fa-envelope", color: "#3498db", x: 170, y: 530 },
            { name: "音乐", icon: "fa-solid fa-music", color: "#e74c3c", x: 250, y: 530 },
    ...
    sidebarTools: {
        windows: [
            ...
            { title: "office", items: [ { name: "Word", icon: "fa-solid fa-file-word", color: "#0984e3" }, { name: "Excel", icon: "fa-solid fa-file-excel", color: "#00b894" } ] },
            { title: "system", items: [ { name: "Chrome", icon: "fa-brands fa-chrome", color: "#fab1a0" }, { name: "Edge", icon: "fa-brands fa-edge", color: "#74b9ff" } ] }
        ],
        mobile: [
            { 
                title: "wallpaper", type: "wallpaper",
            ...
            { title: "social", items: [ { name: "微信", icon: "fa-brands fa-weixin", color: "#2ecc71" }, { name: "抖音", icon: "fa-brands fa-tiktok", color: "#2d3436" } ] }
        ]
    }
};
